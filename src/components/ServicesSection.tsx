      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6">
        {services.map(({ title, desc }, idx) => (
          <FadeInWhenVisible key={idx}>
            <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 shadow-sm hover:shadow-lg hover:scale-[1.02] transition-transform duration-300">
